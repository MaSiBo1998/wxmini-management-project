  ...
  <div class="app-container">
    ...
    <div class="table-box">
      <el-table ref="table" v-loading="crud.loading" max-height="600" stripe lazy :data="crud.data">
        ...
        <el-table-column prop="unFirstConfirmCount" align="center" label="未确认订单数" width="120">
        </el-table-column>
        ...
        <el-table-column prop="otherAppRejectCount" align="center" label="advance拒绝数" width="120">
        </el-table-column>
        <el-table-column prop="otherAppRejectRate" align="center" label="advance拒绝率" width="120">
        </el-table-column>
        ...
        <el-table-column prop="jinguoRequestCount" align="center" label="金果调用数" width="120">
        </el-table-column>
