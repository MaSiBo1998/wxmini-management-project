  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-date-picker v-model="query.createTime" multiple type="daterange" value-format="yyyy-MM-dd" range-separator=":"
    ...
    <div class="table-box">
      <el-table ref="table" v-loading="crud.loading" max-height="600" stripe lazy :data="crud.data">
        <el-table-column prop="appName" align="center" label="App名称" fixed width="120">
        </el-table-column>
        <el-table-column prop="platform" align="center" label="平台" fixed>
        </el-table-column>
        <el-table-column prop="date" align="center" label="日期" width="100px" fixed>
        </el-table-column>
        <el-table-column prop="firstIconPv" align="center" label="首页icon(PV)" width="100px">
        </el-table-column>
        <el-table-column width="100px" prop="firstIconUv" align="center" label="首页icon(UV)">
        </el-table-column>
        <el-table-column width="100px" prop="firstPopPv" align="center" label="首页弹窗(PV)">
        </el-table-column>
        <el-table-column width="100px" prop="firstPopUv" align="center" label="首页弹窗(UV)">
        </el-table-column>
        <el-table-column width="100px" prop="personCenterPv" align="center" label="个人中心(PV)">
        </el-table-column>
        <el-table-column width="100px" prop="personCenterUv" align="center" label="个人中心(UV)">
        </el-table-column>
        <el-table-column prop="inviteRegisterCount" align="center" label="注册人数">
        </el-table-column>
        <el-table-column width="100px" prop="h5VisitCount" align="center" label="页面访问人数">
        </el-table-column>
        <el-table-column width="150px" prop="h5VisitRate" align="center" label="页面访问人数/注册人数">
        </el-table-column>
        <el-table-column width="100px" prop="sendInviteCount" align="center" label="发起邀请人数">
        </el-table-column>
        <el-table-column width="110px" prop="sendInviteRate" align="center" label="发起邀请转化率">
        </el-table-column>
        <el-table-column width="100px" prop="invalidInviteCount" align="center" label="无效邀请人数">
        </el-table-column>
        <el-table-column width="100px" prop="inviteLoginCount" align="center" label="邀请登录人数">
        </el-table-column>
