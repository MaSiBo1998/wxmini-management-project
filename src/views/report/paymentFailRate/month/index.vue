  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-date-picker v-model="query.createTime" type="monthrange" value-format="yyyyMM" range-separator=":"
    ...
    <div class="table-box">
      <el-table ref="table" v-loading="crud.loading" max-height="600" stripe lazy :data="crud.data">
        ...
        <el-table-column prop="dateMonth" align="center" label="日期" fixed>
        </el-table-column>
