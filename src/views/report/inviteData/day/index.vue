  ...
  <div class="app-container">
    ...
    <div class="table-box">
      <el-table ref="table" v-loading="crud.loading" max-height="600" stripe lazy :data="crud.data">
        ...
        <el-table-column prop="inviteDateStr" align="center" label="日期" width="100px" fixed>
        </el-table-column>
  ...
  methods: {
    ...
    [CRUD.HOOK.beforeRefresh](crud) {
      if (this.query.createTime) {
        crud.query.startDate = this.query.createTime[0];
        crud.query.endDate = this.query.createTime[1];
      } else {
