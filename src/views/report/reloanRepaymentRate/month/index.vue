  ...
  <div class="app-container">
    ...
    <div class="table-box">
      ...
      <el-table-column prop="appName" align="center" label="App名称" fixed>
        ...
        <el-table-column prop="loanTimes" align="center" label="贷次">
        </el-table-column>
        <el-table-column prop="repayCount" align="center" label="还款人数" width="180">
        </el-table-column>
        <el-table-column prop="reLoanApplyCount" align="center" label="复贷正式订单创建人数" width="180">
        </el-table-column>
        <el-table-column prop="repayRate" align="center" label="订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T0Rate" align="center" label="T0订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T1Rate" align="center" label="T1订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T3Rate" align="center" label="T3订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T7Rate" align="center" label="T7订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T15Rate" align="center" label="T15订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T30Rate" align="center" label="T30订单/还款" width="130">
        </el-table-column>
        <el-table-column prop="T30PlusRate" align="center" label="T30+订单/还款" width="130">
        </el-table-column>
    </el-table>
    </div>
...
export default {
  ...
  cruds() {
    return CRUD({
      url: "/reLoanRePay/queryDetailMonth",
      method: "get"
    });
  },
