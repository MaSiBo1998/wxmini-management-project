  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-select v-model="appNames" clearable size="small" filterable placeholder="请选择APP名称" class="filter-item"
          ...
          <el-col :span="6">
            <el-select v-model="query.riskPassType" @change="crud.toQuery()" clearable size="small" filterable
              placeholder="请选择首贷风控通过类型" class="filter-item" style="width: 100%">
          ...
          <el-col :span="6">
            <el-select v-model="riskLevels" clearable size="small" filterable placeholder="请选择风险等级" class="filter-item"
              style="width: 100%" multiple>
...
export default {
  ...
  created() {
    // console.log(this.crud,this.crud.data2)
    let data = this.crud.data2
    console.log(data)
  },
  methods: {
