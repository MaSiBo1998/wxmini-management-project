  ...
  <div class="app-container">
    ...
    <div class="table-box">
      ...
      <el-table-column prop="appName" align="center" label="App名称" fixed>
        ...
        <el-table-column prop="reLoanCount" align="center" label="复贷总数" width="180">
        </el-table-column>
        <el-table-column prop="repayRate" align="center" label="复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T0Rate" align="center" label="T0复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T1Rate" align="center" label="T1复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T3Rate" align="center" label="T3复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T7Rate" align="center" label="T7复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T15Rate" align="center" label="T15复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T30Rate" align="center" label="T30复贷/还款" width="130">
        </el-table-column>
        <el-table-column prop="T30PlusRate" align="center" label="T30+复贷/还款" width="130">
        </el-table-column>
    </el-table>
    </div>
...
export default {
  ...
  cruds() {
    return CRUD({
      url: "/reLoanConfirm/queryDetailMonth",
      method: "get"
    });
  },
