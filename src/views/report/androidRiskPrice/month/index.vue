    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-select v-model="query.riskLevel" @change="crud.toQuery()" clearable size="small" filterable
              placeholder="请选择风险等级" class="filter-item" style="width: 100%">
